...
trackone_path = f"fcc_ee_test_simulation/tbt/trackone"    # The original trackone path
twiss_path = f"fcc_ee_test_simulation/twiss.optics"       # The twiss files to use    


save_path = f"fcc_ee_test_simulation/tbt_simu/sim_tbt"
