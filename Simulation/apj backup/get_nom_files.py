...
original_model_dir=args.input_dir       # Where the model is alocated (the .seq with the data)
...
job_orig_file=original_model_dir + "/" + "get_real_twiss_data.madx"                  # Original job.twiss.madx
...
job_file =  out_dir + 'get_real_twiss_data.madx'
