...
trackone_path = f"fcc_ee_corrections/tbt/trackone"    # The original trackone path
twiss_path = f"fcc_ee_corrections/twiss.optics"       # The twiss files to use    


save_path = f"fcc_ee_corrections/tbt_simu/sim_tbt"
